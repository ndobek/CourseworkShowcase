...
extern char SCI0_Timeout_DataIncoming;
extern char SCI0_Timeout_DataComplete;
extern char SCI0_Timeout_BufferOverflow;

extern int SCI0_Timeout_BufferSize;
extern int SCI0_Timeout_DataSize;

extern char* SCI0_Timeout_Data;
...
char SCI0_Read_Timeout(void);
void SCI0_Timeout_ClearBuffer(void);
...
void SCI0_Write_String (char const * straddr);
